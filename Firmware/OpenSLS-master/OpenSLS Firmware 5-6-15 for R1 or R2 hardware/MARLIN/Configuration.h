...
#define STRING_CONFIG_H_AUTHOR "(ata, SLS)" // Who made the changes.
...
// AMRI Laser Cutter
#define DEFAULT_AXIS_STEPS_PER_UNIT   {167.20882, 167.20882, 80, 3200}
#define DEFAULT_MAX_FEEDRATE          {165, 165, 165, 200000}    // (mm/sec)    
